...
function sesliHarfSayaci(argStr) {
  let sesliHarf = [a,e,ı,i,o,ö,u,ü,A,E,I,İ,O,Ö,U,Ü];
  let kacSesli = 0;
  for(let i=0; i<argStr.length; i++){
    if(sesliHarf.includes(argStr[i])){
      kacSesli ++;
    }
  }
  return kacSesli;
